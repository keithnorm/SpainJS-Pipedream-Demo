...
require.define("/node_modules/underscore/underscore.js",function(require,module,exports,__dirname,__filename,process){//     Underscore.js 1.4.4
...
require.define("/server.sync.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  ...
  module.exports = function(method, model, options) {
    ...
    return request.get(params.url, function(error, response, body) {
      return params.success(model, JSON.parse(body), options);
    });
  };
...
require.define("/node_modules/backbone/backbone.js",function(require,module,exports,__dirname,__filename,process){/*jsl:ignore*/
//     Backbone.js 0.9.10
...
(function(){
  ...
  _.extend(Collection.prototype, Events, {
    ...
    fetch: function(options) {
      console.log('CALLED FETCH', options);
      options = options ? _.clone(options) : {};
      if (options.parse === void 0) options.parse = true;
      var success = options.success;
...
require.define("/backbone.server.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var Backbone, app, browserify, bundle, cheerio, express, fileify, fs, socket, templates, _;
  ...
  Backbone.Router.prototype.route = function(route, name) {
    ...
    return app.get(route, function(req, res) {
      var callback;
      _this.res = res;
      callback = _this[_this.routes[route]];
...
require.define("/server.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var AboutView, Backbone, HomeView, Router, Tweets, hogan, io, router, server, _,
