...
require.define("/node_modules/Templates",function(require,module,exports,__dirname,__filename,process){module.exports = {"layout.html":"<!doctype html>\n<html>\n  <head>\n    <style type=\"text/css\" media=\"screen\">\n      body {\n        font-family: Arial;\n      }\n    </style>\n    <script type=\"text/javascript\" charset=\"utf-8\" src='/js/jquery.js'></script>\n    <script type=\"text/javascript\" charset=\"utf-8\" src='/socket.io/socket.io.js'></script>\n    <script type=\"text/javascript\" charset=\"utf-8\" src='/js/app.js'></script>\n\n    <script type=\"text/javascript\" charset=\"utf-8\" src='/js/reloader.js'></script>\n  </head>\n  <body>\n    <a href='/'>Home Page</a> | <a href='/about'>About</a>\n    <div id='main'>\n      {{{ body }}}\n    </div>\n  </body>\n</html>\n"}
});
...
require.define("/backbone.client.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var Backbone;

  Backbone = require('backbone');

  Backbone.Router.prototype.render = function(view) {
    return view.render();
  };

  Backbone.Router.prototype.listen = function() {
    return $(function() {
  ...
  Backbone.Router.prototype._routeToRegExp = (function(original) {
    var _this = this;
...
require.define("/backbone.server.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var Backbone, app, cheerio, express, fs, _;
  ...
  Backbone.Router.prototype.route = function(route, name, callback) {
    ...
    return app.get(route, function(req, res) {
      _this.res = res;
      return callback.apply(_this, _(req.query).values());
    });
  };
  ...
  Backbone.Router.prototype.listen = function(port) {
...
require.define("/node_modules/cheerio/package.json",function(require,module,exports,__dirname,__filename,process){module.exports = {"main":"./index.js"}});

require.define("/node_modules/cheerio/index.js",function(require,module,exports,__dirname,__filename,process){var fs = require('fs');
...
require.define("/node_modules/cheerio/lib/cheerio.js",function(require,module,exports,__dirname,__filename,process){/*
  Module dependencies
*/
...
require.define("/node_modules/cheerio/node_modules/cheerio-select/package.json",function(require,module,exports,__dirname,__filename,process){module.exports = {"main":"index"}});

require.define("/node_modules/cheerio/node_modules/cheerio-select/index.js",function(require,module,exports,__dirname,__filename,process){exports = module.exports = require('./lib/select');
...
require.define("/node_modules/cheerio/node_modules/cheerio-select/lib/select.js",function(require,module,exports,__dirname,__filename,process){/*
 * Module dependencies
 */
...
require.define("/node_modules/cheerio/node_modules/cheerio-select/node_modules/CSSselect/package.json",function(require,module,exports,__dirname,__filename,process){module.exports = {"main":"index.js"}});

require.define("/node_modules/cheerio/node_modules/cheerio-select/node_modules/CSSselect/index.js",function(require,module,exports,__dirname,__filename,process){;(function(global, CSSwhat){
"use strict";
...
require.define("/node_modules/cheerio/node_modules/cheerio-select/node_modules/CSSselect/node_modules/CSSwhat/package.json",function(require,module,exports,__dirname,__filename,process){module.exports = {"main":"/index.js"}});

require.define("/node_modules/cheerio/node_modules/cheerio-select/node_modules/CSSselect/node_modules/CSSwhat/index.js",function(require,module,exports,__dirname,__filename,process){;(function(global){ "use strict";
...
require.define("/server.sync.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var request, _;
  ...
  module.exports = function(method, model, options) {
    ...
    return request.get(params.url, function(error, response, body) {
      return params.success(JSON.parse(body));
    });
  };
...
require.define("/server.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var AboutView, Backbone, HomeView, Router, Tweets, browserify, bundle, fileify, fs, hogan, io, router, server, socket, templates, _,
  ...
  if (process.browser) {
    ...
    templates = fileify('Templates', process.cwd() + '/views', {
      watch: true
    });
    bundle.use(templates);
    bundle.addEntry("./server.coffee");
    bundle.on('bundle', function() {
      return fs.writeFile('./public/js/app.js', bundle.bundle(), function() {
        if (socket.emit != null) {
  ...
  Router = (function(_super) {
    ...
    Router.prototype.root = function() {
      ...
      tweets = new Tweets();
      return tweets.fetch({
        success: function(tweets, response) {
          return _this.render(new HomeView({
    ...
    Router.prototype.about = function() {
      return this.render(new AboutView());
    };
  ...
  Tweets = (function(_super) {
    ...
    Tweets.prototype.url = 'http://search.twitter.com/search.json?q=spainjs&rpp=10&include_entities=true&result_type=recent&callback=?';
  ...
  HomeView = (function(_super) {
    ...
    HomeView.prototype.template = "<h1>Spain JS RULES!</h1>\n<ul>\n  {{# tweets }}\n    <li>{{ attributes.text }}</li>\n  {{/ tweets }}\n</ul>";

    HomeView.prototype.initialize = function(options) {
      return this.tweets = options.tweets;
    };

    HomeView.prototype.toHTML = function() {
      var template;
      template = hogan.compile(this.template);
  ...
  AboutView = (function(_super) {
    ...
    AboutView.prototype.template = "<h2>A summer javascript conference in Spain</h2>\n<h3>July 5-7, 2012 - Florida Park (Parque del Retiro) Madrid</h3>";

    AboutView.prototype.toHTML = function() {
